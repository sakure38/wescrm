package com.we.scrm.common.page;
...
public class Pagination<E> extends AbstractPage<E> {
     ...
     * @param items
     */
    public Pagination(IPage<E> page, Collection<E> items ,int itemsTotalCount) {
        this(page.getPageNum(), page.getPageSize(), itemsTotalCount , items);
    }

    public Pagination(int pageNum, int pageSize , int itemsTotalCount , Collection<E> items) {
